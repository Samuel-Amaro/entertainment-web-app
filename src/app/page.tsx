	...
	return (
		<div className={styles.container}>
			<header className={styles.header}>
				<FormSearch placeholder="Search for movies or TV Series" searchFor="multi" />
			</header>
			<main className={styles.main}>
				<Suspense fallback={<SkeletonSectionTrendingMovie limitRenderingItems={20} />}>
				...
				<Suspense fallback={<SkeletonSectionTrending limitRenderingItems={20} />}>
					<SectionTrendingTv />
				</Suspense>
				<Suspense fallback={<SkeletonSectionCommon limitRenderingItems={10} />}>
					<SectionAiringToday />
