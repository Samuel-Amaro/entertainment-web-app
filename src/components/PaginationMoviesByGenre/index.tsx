...
async function fetcher(url: string) {
	...
	if (!response.ok) {
		throw new Error('Failed to fetch datas by movies from genre, datas pagination');
	}
...
export default function PaginationMoviesByGenre({ idGenre, pageIndex, nameGenre }: Props) {
