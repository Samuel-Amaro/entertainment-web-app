...
export default function DatasCard({ mediaType, date, titleOrName, className }: PropsDatasCard) {
	return (
		<div className={className ? className : undefined}>
			<p className={styles.container}>
				<span className={styles.year}>
					{typeof new Date(date).getFullYear() !== 'number' || isNaN(new Date(date).getFullYear())
						? 'No Year'
